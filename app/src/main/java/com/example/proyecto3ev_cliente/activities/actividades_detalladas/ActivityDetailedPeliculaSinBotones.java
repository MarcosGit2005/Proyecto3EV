...
public class ActivityDetailedPeliculaSinBotones extends BaseActivity implements CallInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vista_detallada_pelicula_sin_botones);
